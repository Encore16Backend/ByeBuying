...
public interface ItemRepo extends JpaRepository<Item, Long> ,ItemRepoCustom{
    ...
    Page<Item> findByNameContainingIgnoreCase(Pageable pageable, String itemname);
    Page<Item> findByCategories_Cateid(Pageable pageable, Long cateid);
    Page<Item> findByCategories_CateidAndNameContainingIgnoreCase(Pageable pageable, Long cateid, String itemname);
