...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .antMatchers("/main/**", "/api/login/**", "/api/checkUser", "/api/user/save", "/api/token/refresh/**","/review/byItemname","/api/checkMail","/review/avg")
                .permitAll();
        ...
        http.authorizeRequests().antMatchers(POST, "/api/user/save/**","/review/save", "/api/user/getUser").hasAnyAuthority("ROLE_USER");
