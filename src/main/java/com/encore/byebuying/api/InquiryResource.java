...
import com.encore.byebuying.api.dto.Inquiry.InquiryAnswerRequest;
...
public class InquiryResource {
    ...
    @PostMapping("/save")
    public ResponseEntity<?> saveInquiry(@RequestBody InquirySaveRequest inquirySaveRequest){
        inquiryService.saveInquiry(inquirySaveRequest);
